              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate="" method="POST" action="{{URL::to('institute-save-batch')}}" enctype="multipart/form-data">
                      @csrf

                      <div class="row g-3">

                        <div class="col-md-4">
                          <label class="form-label" for="validationCustom01">Batch name</label>
                          <input class="form-control" id="validationCustom01" type="text" required="" name="batch_name">
